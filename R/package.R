...
#' @importFrom goalie areSamplesUnique assertAreNonExisting
#'   assertAreUniqueGeneNames assertAreURLs assertAreValidNames
#'   assertFormalCompress assertHasRownames assertHasValidDimnames assertIsAlpha
#'   assertIsANumberOrNULL assertIsAnImplicitInteger
#'   assertIsAnImplicitIntegerOrNULL assertIsAnIntegerOrNULL
...
#'   hasRownames isAnImplicitInteger isURL
