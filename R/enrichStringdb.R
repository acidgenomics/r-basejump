...
enrichStringdb <- function(gene,
    ...
    if (isTRUE(csv)) {
        readr::write_csv(list$geneOntologyBiologicalProcess, file.path(stringDir, "geneOntologyBiologicalProcess.csv"))
        readr::write_csv(list$geneOntologyMolecularFunction, file.path(stringDir, "geneOntologyMolecularFunction.csv"))
        readr::write_csv(list$geneOntologyCellularComponent, file.path(stringDir, "geneOntologyCellularComponent.csv"))
        readr::write_csv(list$kegg, file.path(stringDir, "kegg.csv"))
        readr::write_csv(list$interpro, file.path(stringDir, "interpro.csv"))
        readr::write_csv(list$pfam, file.path(stringDir, "pfam.csv"))
    }
